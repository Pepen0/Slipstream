<p align="center" width="100%">
  <img alt="Logo" width="33%" src="Logos/logo-slipstream.png">
</p>

<h1 align="center">${BOARD_NAME}</h1>

<p align="center" width="100%">
  <a href="${GIT_URL}/actions/workflows/kibot.yml">
    <img alt="CI Badge" src="${GIT_URL}/actions/workflows/kibot.yml/badge.svg">
  </a>
</p>
