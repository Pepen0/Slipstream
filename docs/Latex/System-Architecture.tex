...
% Increased vertical spacing between Game PC and Mechatronics (was 30mm -> 50mm)
\node[box, below=40mm of io, minimum width=72mm, align=center] (bus) {\textbf{Realtime Field Bus}\\CAN-FD (multi-drop) \textit{or} Multi-USB Hub\\\textit{Expansion-ready: +Yaw/+Heave/+Surge}};
