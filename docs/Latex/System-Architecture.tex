...
% >>> Increased horizontal spacing between MCUs (±70mm) and a bit more vertical gap (-18mm)
...
% More vertical breathing room between MCUs and their actuators (below=10mm)
...
\node[box, below=10mm of mcu_pedals, minimum width=62mm, align=left] (act_pedals) {\textbf{Pedal Assemblies}\\Throttle / Brake / Clutch (std. mounts)};
\node[box, below=10mm of mcu_motion, minimum width=62mm, align=left] (act_motion) {\textbf{2-DOF Platform}\\Two 24 V DC motors, worm gears\\U-joint pivot; mechanical stops (±17°)};
