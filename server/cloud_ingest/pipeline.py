...
from .models import AckStatus, IngestAck, QueryRequest, QueryResult, SessionRecord, TelemetryRow
...
class TelemetryIngestionPipeline:
    def __init__(self, store: TelemetryStore, writer: AsyncBatchWriter) -> None:
        self._store = store
        self._writer = writer
